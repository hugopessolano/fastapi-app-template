...
|-------|-------------|-------|
<!-- SKILLS-LIST-START -->
| [scaffold-ui](./skills/scaffold-ui/skill.md) | Next.js UI patterns for the scaffold tooling. | tools/scaffold/ui |
| [ui-skills](./skills/ui-skills/skill.md) | Opinionated constraints for building better interfaces with agents. | tools/scaffold/ui |
<!-- SKILLS-LIST-END -->
